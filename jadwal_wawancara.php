...
<head>
    ...
    <style>
        ...
        /* Styling for date input in dark mode */
        input[type="date"]::-webkit-calendar-picker-indicator {
            filter: invert(0.8); /* Adjust if needed for better visibility of the icon */
        }
    </style>
</head>
...
<body class="bg-primary text-gray-300">
        ...
        <main class="flex-1 p-6 sm:p-8 bg-gray-900 md:ml-64">
            <div class="bg-gray-800 p-6 rounded-xl shadow-lg">
                ...
                <div class="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                    ...
                    <div>
                        <label for="filter-matkul" class="block text-xs font-medium text-gray-400 mb-1">Mata Kuliah</label>
                        <select id="filter-matkul" name="filter-matkul" class="w-full px-4 py-2.5 bg-gray-700 border border-gray-600 text-gray-200 rounded-lg focus:ring-secondary focus:border-secondary">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-[900px]">
                        ...
                        <tbody class="divide-y divide-gray-700">
                            <?php 
                            $jadwal_list = [
                                ["id" => 1, "tanggal" => "2025-06-10", "waktu_mulai" => "09:00", "waktu_selesai" => "09:30", "nama_calon" => "Ahmad Fauzi", "nim_calon" => "201011400001", "matkul" => "Algoritma & Pemrograman", "pewawancara" => "Dr. Indah Permatasari", "lokasi" => "Ruang R.301", "status" => "Terjadwal"],
                                ["id" => 2, "tanggal" => "2025-06-10", "waktu_mulai" => "10:00", "waktu_selesai" => "10:30", "nama_calon" => "Bunga Citra Lestari", "nim_calon" => "211011400002", "matkul" => "Basis Data", "pewawancara" => "Prof. Budi Santoso", "lokasi" => "Online (Zoom)", "status" => "Selesai"],
                                ["id" => 3, "tanggal" => "2025-06-11", "waktu_mulai" => "13:00", "waktu_selesai" => "13:45", "nama_calon" => "Eko Patrio", "nim_calon" => "201011400005", "matkul" => "Basis Data", "pewawancara" => "Prof. Budi Santoso", "lokasi" => "GMeet Link", "status" => "Menunggu Konfirmasi"],
                                ["id" => 4, "tanggal" => "2025-06-12", "waktu_mulai" => "11:00", "waktu_selesai" => "11:30", "nama_calon" => "Siti Aminah", "nim_calon" => "221011400007", "matkul" => "Pemrograman Web", "pewawancara" => "Dr. Rina Kusumawati", "lokasi" => "Ruang R.302", "status" => "Dibatalkan"],
                            ];
                            ...
                            <tr class="hover:bg-gray-700/50">
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-400"><?= $jadwal['waktu_mulai'] ?> - <?= $jadwal['waktu_selesai'] ?> WIB</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-100"><?= $jadwal['nama_calon'] ?></div>
                                    <div class="text-xs text-gray-400">NIM: <?= $jadwal['nim_calon'] ?></div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-200"><?= $jadwal['matkul'] ?></td>
                                <td class="px-6 py-4 text-sm text-gray-200"><?= $jadwal['pewawancara'] ?></td>
                                <td class="px-6 py-4 text-sm text-gray-300">
                                    <?php if (filter_var($jadwal['lokasi'], FILTER_VALIDATE_URL)): ?>
                                        <a href="<?= $jadwal['lokasi'] ?>" target="_blank" class="text-secondary hover:underline"><?= parse_url($jadwal['lokasi'], PHP_URL_HOST) ?: "Link Meeting" ?></a>
                                    <?php else: ?>
                                        <?= $jadwal['lokasi'] ?>
                                    <?php endif; ?>
                                </td>
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-primary z-[60] hidden flex-col pt-0 md:hidden">
        ...
        <div class="container mx-auto px-4 py-4">
            ...
            <a href="jadwal_wawancara.php" class="block py-3 text-lg font-medium border-b border-gray-700 text-secondary bg-gray-700/50 rounded">Jadwal Wawancara</a> <a href="pengumuman_admin.php" class="block py-3 text-lg font-medium border-b border-gray-700 text-gray-200 hover:text-secondary">Pengumuman</a>
    ...
    <script id="dropdown-mobile-menu-script">
        // ... (JavaScript sama seperti di pendaftar.php)
